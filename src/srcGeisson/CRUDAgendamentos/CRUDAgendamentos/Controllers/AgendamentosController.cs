...
namespace CRUDAgendamentos.Controllers
{
    public class AgendamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,Pontuacao,Estado,Cidade,Bairro,Rua,NumeroCasa,Cep")] Agendamento agendamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Data,Pontuacao,Estado,Cidade,Bairro,Rua,NumeroCasa,Cep")] Agendamento agendamento)
        {
